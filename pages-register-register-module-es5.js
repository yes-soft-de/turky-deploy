...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-register-register-module"], {
  ...
  function srcAppPagesRegisterComponentsLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _service_register_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    ...
    var LoginComponent = /*#__PURE__*/function () {
      function LoginComponent(registerService, tokenService, authService, router, route) {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function onSubmit() {
          ...
          this.registerService.login(this.form).subscribe(function (response) {
    ...
    LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 29,
      vars: 10,
      consts: [[1, "col-12", "col-sm-11", "col-md-9", "col-lg-7", "col-xl-7", "mx-auto", "my-5"], [1, "text-center", "text-muted", "mb-3"], [1, "card"], [1, "cord-header"], [1, "card-body"], [1, "alert", "alert-danger", "mb-0", "my-2", 3, "hidden"], [3, "ngSubmit"], ["loginForm", "ngForm"], [1, "form-group", "row"], ["for", "inputEmail3", 1, "col-12", "col-sm-2", "col-md-3", "col-lg-2", "col-xl-2", "col-form-label"], [1, "col-12", "col-sm-10", "col-md-9", "col-lg-10", "col-xl-10"], ["type", "text", "name", "username", "id", "inputEmail3", "placeholder", "Username", "required", "", 1, "form-control", 3, "ngModel", "ngModelChange"], [1, "alert", "alert-danger", "mb-0", "mt-2", 3, "hidden"], ["for", "inputPassword3", 1, "col-12", "col-sm-2", "col-md-3", "col-lg-2", "col-xl-2", "col-form-label"], ["type", "password", "name", "password", "id", "inputPassword3", "placeholder", "Password", "required", "", 1, "form-control", 3, "ngModel", "ngModelChange"], [1, "col-12"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], ["class", "text-success m-2", 4, "ngIf"], [1, "text-success", "m-2"]],
  ...
  function srcAppPagesRegisterRegisterModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    RegisterModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[src_app_theme_theme_module__WEBPACK_IMPORTED_MODULE_1__["ThemeModule"], _register_routing_module__WEBPACK_IMPORTED_MODULE_2__["RegisterRoutingModule"]]]
    });
